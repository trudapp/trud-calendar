...
Consulta [Zonas horarias](/es/timezones/) para la guia completa, incluyendo casos limite de DST y como interactuan `event.timeZone` y `displayTimeZone`.
...
Consulta [Recurrencia](/es/recurrence/) para documentacion detallada.
